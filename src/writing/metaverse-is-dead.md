...
<nav class="toc" aria-label="Table of contents">
  ...
  <ol>
    <li><a href="#what-happened">What Happened to the Metaverse?</a></li>
    <li><a href="#why-it-failed">Why the Metaverse Failed</a></li>
    <li><a href="#horizon-worlds">What Went Wrong with Horizon Worlds</a></li>
    <li><a href="#80-billion">The $80 Billion Lesson</a></li>
    <li><a href="#meta-ai-pivot">Meta's Pivot to AI</a></li>
    <li><a href="#what-survived">What Actually Survived from VR</a></li>
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "The Metaverse Is Dead: What Killed It and What Comes Next (2026)",
  "description": "Meta spent $80 billion on the metaverse and shut it down. What killed virtual reality's biggest bet, why Horizon Worlds failed, and what Meta's AI pivot means for tech.",
  "author": { "@type": "Person", "name": "Samuel Mamootil", "url": "https://samuelmamootil.github.io" },
  "datePublished": "2026-05-20",
  "dateModified": "2026-05-20",
  "mainEntityOfPage": "https://samuelmamootil.github.io/writing/metaverse-is-dead/"
}
</script>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is the metaverse dead?",
      "acceptedAnswer": { "@type": "Answer", "text": "Effectively, yes — at least Meta's version of it. In 2026, Meta announced it would stop allowing new VR apps in Horizon Worlds and shifted its flagship app away from virtual reality headsets. After losing roughly $80 billion on the project, Meta has redirected its investment almost entirely toward artificial intelligence." }
    },
    {
      "@type": "Question",
      "name": "Why did the metaverse fail?",
      "acceptedAnswer": { "@type": "Answer", "text": "The metaverse failed for several reasons: VR headsets were too expensive and uncomfortable for mass adoption, Horizon Worlds had poor user experience and low retention, the use case for most people was unclear, and competing platforms like Roblox and Fortnite already owned the social gaming space without requiring headsets." }
    },
    {
      "@type": "Question",
      "name": "How much money did Meta lose on the metaverse?",
      "acceptedAnswer": { "@type": "Answer", "text": "Meta's Reality Labs division — responsible for the metaverse and VR hardware — lost approximately $80 billion over the course of the project. In 2023 alone, Reality Labs lost over $16 billion." }
    },
    {
      "@type": "Question",
      "name": "What is Meta doing instead of the metaverse?",
      "acceptedAnswer": { "@type": "Answer", "text": "Meta has pivoted entirely to artificial intelligence. Mark Zuckerberg has declared AI — specifically 'superintelligence' — as the company's new north star. Meta plans to spend at least $115 billion in 2026, primarily on AI infrastructure including massive data centers, the Llama open-source model family, and AI-powered features across Facebook, Instagram, and WhatsApp." }
    },
    {
      "@type": "Question",
      "name": "What happened to Horizon Worlds?",
      "acceptedAnswer": { "@type": "Answer", "text": "Horizon Worlds, Meta's flagship virtual reality social platform, was effectively wound down as a VR-first product. In early 2026, Meta announced users would no longer be able to access the immersive world through VR headsets, then partially walked that back — but confirmed no new VR apps would be added. The platform is being repositioned away from its original vision." }
    },
    {
      "@type": "Question",
      "name": "Will virtual reality ever go mainstream?",
      "acceptedAnswer": { "@type": "Answer", "text": "VR remains a niche technology used by hobbyists, some enterprise training applications, and gaming enthusiasts. While hardware like the Meta Quest continues to sell, mass consumer adoption has not materialised. Mixed reality (AR+VR) through devices like Apple Vision Pro may find a narrower professional use case, but the broad social metaverse vision has not proven viable." }
    }
  ]
}
</script>
...
## What Happened to the Metaverse? {% raw %}{#{% endraw %}what-happened}
...
## Why the Metaverse Failed {% raw %}{#{% endraw %}why-it-failed}
...
## What Went Wrong with Horizon Worlds {% raw %}{#{% endraw %}horizon-worlds}
...
## The $80 Billion Lesson {% raw %}{#{% endraw %}80-billion}
...
## Meta's Pivot to AI {% raw %}{#{% endraw %}meta-ai-pivot}
...
## What Actually Survived from VR {% raw %}{#{% endraw %}what-survived}
...
## What Comes Next {% raw %}{#{% endraw %}what-comes-next}
...
Effectively yes — Meta's version of it. In 2026, Meta stopped supporting new VR apps in Horizon Worlds and shifted the platform away from VR headsets. After losing roughly $80 billion, Meta has redirected investment almost entirely to AI.

**Why did the metaverse fail?**
VR headsets were too expensive and uncomfortable for mass adoption, Horizon Worlds had poor user experience and low retention, the use case was unclear, and competing platforms like Roblox and Fortnite already owned the social digital world space without requiring headsets.

**How much money did Meta lose on the metaverse?**
Meta's Reality Labs division lost approximately $80 billion over the course of the project — over $16 billion in 2023 alone.

**What is Meta doing instead of the metaverse?**
Meta has pivoted to AI. Zuckerberg has declared "superintelligence" the company's new north star. Meta plans to spend at least $115 billion in 2026 on AI infrastructure, data centers, and the Llama open-source model family.

**What happened to Horizon Worlds?**
Horizon Worlds was effectively wound down as a VR-first product. Meta announced in early 2026 that users could no longer access it through VR headsets, then partially reversed — but confirmed no new VR apps would be added. The original vision is over.

**Will virtual reality ever go mainstream?**
VR remains niche — used by gaming enthusiasts, some enterprise training applications, and hobbyists. Mass consumer adoption has not materialised. Mixed reality may find a narrower professional use case, but the broad social metaverse vision has not proven viable.

---

*Interested in where AI infrastructure is actually heading? I write about cloud engineering, AWS, and agentic AI. [Connect on LinkedIn](https://linkedin.com/in/samuel-mamootil).*
